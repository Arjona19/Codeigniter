...
<script>
    window.onload = function(){
        iziToast.show({
            ...
            backgroundColor: '#6E16AF', // dark
            icon: 'fa fa-power-off',
            title:'Hola! Roberto',
            message:'Has iniciado sesión',
            position: 'bottomCenter',
            iconColor: 'white',titleColor: 'white',
            messageColor: 'white',
            iconUrl: null,
            image: '<?php echo $url; ?>images/icon/fest-icon-02.png',
            imageWidth: 50,
        });
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="form.html">
                                <i class="far fa-user"></i>Nosotros</a>
                        </li>
                    </ul>
                </div>
            </nav>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    ...
                                    <a href="NuevoBlog" class="au-btn au-btn-icon au-btn--blue">
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <img class="card-img-top" src="<?php echo $url; ?>images/bg-title-01.jpg" alt="Card image cap">
                                    <div class="card-body">
